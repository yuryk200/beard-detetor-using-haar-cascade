This project invloved making a script to detect whether a person has a beard or not but using specifically image processing techniques rather than machine learning model to detect it.
